...
const LAYERS: Array<{ key: keyof MapLayerVisibility; label: string; source: string; status: string; description: string; configured?: boolean; visual: LayerVisual }> = [
  ...
  },
  {
    ...
    source: "State DOT / 511",
    status: "AR/IA/KS/MO/OK/TN",
    visual: "road",
    description: "Public DOT closures, crashes, flooding, construction, winter pavement conditions, lane restrictions, and route-impacting hazards. Coverage: Arkansas, Iowa, Kansas, Missouri, Oklahoma, and Tennessee.",
  },
  {
    key: "trafficCameras",
    label: "Traffic / Public Cameras",
    source: "State DOT / 511",
    status: "AR/IA/KS/MO/NE/TN",
    visual: "camera",
    description: "Public traffic and RWIS cameras for Arkansas, Iowa, Kansas, Missouri, Nebraska, and Tennessee. Selecting an individual camera opens its live view immediately; wide views cluster dense areas.",
  },
  {
    key: "surfaceStations",
  ...
  },
  {
    ...
    status: "2-hour rolling",
    visual: "warning",
    description: "Recent Local Storm Reports and Spotter Network ground-truth reports. Reports fade after 45 minutes and leave the map after two hours.",
  },
  {
    key: "riverGauges",
    label: "River Gauges",
    ...
    status: "Zoom 5+",
    visual: "station",
    description: "Live USGS gauge height and one-hour rise/fall rate. Hidden at national zoom to avoid a blanket of low-priority station pins.",
  },
  {
    key: "probes",
